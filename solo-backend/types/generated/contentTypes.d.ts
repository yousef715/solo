...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User comments and Q&A on modules';
    displayName: 'Comment';
    pluralName: 'comments';
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Learning blocks for courses';
    displayName: 'Module';
    pluralName: 'modules';
    singularName: 'module';
  };
...
export interface ApiProgressTrackingProgressTracking
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::progress-tracking.progress-tracking': ApiProgressTrackingProgressTracking;
